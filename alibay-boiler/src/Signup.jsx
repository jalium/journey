...
class Signup extends Component { 
    ...
    handleSubmit = evt => { 
        ...
        this.props.dispatch({ //might need to change if we put in travel agent vs. traveller
            type: "login-success"
        })
    } 
    render = () => { 
        return ( 
            <form onSubmit={this.handleSubmit}> 
                <h3>Sign Up</h3>
                Username
                <input type="text" placeholder="Enter your username here" onChange={this.handleUsernameChange} /> 
                Password
                <input type="text" placeholder="Enter your password here" onChange={this.handlePasswordChange} /> 
                <input type="submit" /> 
            </form> 
        ) 
    } 
